...
public class SmartLog {
    ...
    public synchronized static SmartLog getInstance() {
        mLog = new SmartLog();
        return mLog;
    }

    public SmartLog setLogLevel(int logLevel) {
        if (!checkInit()) {
            return mLog;
        }
     ...
     * @return
     */
    public SmartLog setFilter(int filter) {
        if (!checkInit()) {
            return mLog;
        }
...
//        }
    ...
    private static boolean checkInit() {
        if (mLog == null) {
//            SmartException.handleException(new InitException());
            return false;
        }
        return true;
    }
